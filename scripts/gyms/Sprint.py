...
'''
Objective:
Learn how to sprint forward using the Step primitive
----------
- class Sprint: implements an OpenAI custom gym
...
class Sprint(gym.Env):
    def __init__(self, ip, server_p, monitor_p, r_type, enable_draw) -> None:
        ...
        self.step_default_dur = 6
        self.step_default_z_span = 0.045
        self.step_default_z_max = 0.75
